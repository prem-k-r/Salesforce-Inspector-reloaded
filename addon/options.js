    ...
    this.tabs = [
      ...
      },
      {
        ...
        content: [
          ...
          {option: Option, props: {type: "toggle", title: "Enable Smart Paste for Query Inputs", key: "enableSmartPaste", default: false, tooltip: "Detects when you are pasting spreadsheet columns into list clauses and formats them into valid SOQL syntax automatically. Note: Smart Paste resets the undo history. You cannot use Ctrl+Z to undo changes made prior to pasting."}},
          {option: Option, props: {type: "toggle", title: "Auto-split and merge large IN (...) clauses", key: Constants.AUTO_SPLIT_LARGE_IN_CLAUSES, default: false, tooltip: "Automatically breaks down large IN clauses into smaller batches to prevent errors. Note: Supported only for queries containing a single IN clause with quoted values, and very large queries may be abbreviated in the query history."}},
